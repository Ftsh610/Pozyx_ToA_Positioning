...
if __name__ == "__main__":
	...
	# destination_id = [0x671b, 0x6758, 0x6714, 0x6917 ]


	##  3   4
	##
	##  1   2
	destination_id = [0x6738, 0x674f, 0x673b, 0x677d ]
	...
	#AP 234 10
	# H = np.array([ [6.60,-0.03,-0.02], [6.60,7.52,-0.01], [0.50,7.54,-0.01]])#*1000 # mm unit.

	#폴
	H = np.array([ [4.8, 0], [0,8.4], [4.8,8.4]])#*1000 # mm unit.
	#AP03 0/0/-2
	#AP04 0/-3/-1
	#AP10 +1/-1/-1
...
while (1):
	...
	# (3,6) : ( 393,  875) -> ( 393,  119)
	# 22222
	# known_anchors = np.array([ [0,0,162], [480, 0,162], [0,840,162], [480,840,162] ])
	# # 11111
